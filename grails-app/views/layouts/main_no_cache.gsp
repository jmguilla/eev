...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"><!--<![endif]-->
	<head>
		...
		<!-- iPhone -->
		<link href="${resource(dir: 'images/icons', file: 'apple-touch-startup-image-320x460.png')}" media="(device-width: 320px) and (device-height: 480px) and (-webkit-device-pixel-ratio: 1)" rel="apple-touch-startup-image">
		<!-- iPhone (Retina) -->
		<link href="${resource(dir: 'images/icons', file: 'apple-touch-startup-image-640x920.png')}" media="(device-width: 320px) and (device-height: 480px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image">
		<!-- iPhone 5 -->
		<link href="${resource(dir: 'images/icons', file: 'apple-touch-startup-image-640x1096.png')}" media="(device-width: 320px) and (device-height: 568px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image">
		<%--
		<!-- iPad (portrait) -->
