...
class BootStrap {
  ...
  def init = { servletContext ->
    ...
    if(User.count() < 2){
      UserRole.create(new User(username: "jmguilla", password: "jM3u1llA", email: "guillauj@gmail.com").save(failOnError: true), admin)
      UserRole.create(new User(username: "adifolco", password: "aD1f0l6o", email: "anthonydifolco@gmail.com").save(failOnError: true), admin)
    }
